About isort-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/isort-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=466&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/isort-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `isort` can be installed with `conda`:
...
It is possible to list all of the versions of `isort` available on your platform with `conda`:
...
```
mamba search isort --channel conda-forge
```
...
mamba repoquery search isort --channel conda-forge

# List packages depending on `isort`:
mamba repoquery whoneeds isort --channel conda-forge

# List dependencies of `isort`:
mamba repoquery depends isort --channel conda-forge
```
